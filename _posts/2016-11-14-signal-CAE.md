...
출처 :
https://github.com/sjchoi86/tensorflow-101/blob/master/notebooks/cae_mnist.ipynb

이미지예제는 깃에있는 코드를 그대로 넣음
...
이미지도 신호이긴 하지만 우리는 input 을 ($1\times N$)크기의 신호로, convolution을 ($n \times 1$)의
wavelet 처럼 만들고 싶다.
- CAE로 wavelet찾기?
